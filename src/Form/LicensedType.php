    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('gender', ChoiceType::class, array(
                'label' => 'Genre',
                'choices' => array('Veuillez sélectionner un genre' => null, 'Homme' => 'male', 'Femme' => 'female'),
                'constraints' => [
                    new NotBlank([
            ...
            ->add('discipline', ChoiceType::class, array(
                'label' => 'Discipline',
                'choices'   => array('Veuillez sélectionner une discipline' => null, 'Baby Gym' => 'Baby Gym', 'Gymnastique masculine' => 'Male Gym', 'Loisir' => 'Hobbies'),
                'constraints' => [
                    new NotBlank([
